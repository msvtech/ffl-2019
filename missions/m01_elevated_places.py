...
def m01_ElevatedPlaces():
    ...
    tank_drive.on_for_degrees(SpeedPercent(20), SpeedPercent(-20), rotate * 125)
    tank_drive.on_for_degrees(SpeedPercent(100), SpeedPercent(100), ratio_degrees_to_inches * 20)
    tank_drive.on_for_degrees(SpeedPercent(20), SpeedPercent(20), ratio_degrees_to_inches * 20)
